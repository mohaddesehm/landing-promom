...
const FilteredCardFormContainer: NextPage = () => {
  return (
    <section className="self-stretch bg-main-green-3 flex flex-col items-center justify-center py-[5rem] px-[11.88rem] text-center text-[2.25rem] text-text-primary-black-100 font-landing-h9-input-titles">
      <div className="self-stretch flex flex-col items-center justify-center">
        <div className="w-[89.31rem] h-[59rem] flex flex-col items-center justify-start">
          <div className="self-stretch flex flex-col items-center justify-start gap-[5.38rem]">
