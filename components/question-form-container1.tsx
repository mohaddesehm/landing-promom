...
const QuestionFormContainer1: NextPage = () => {
  return (
    <section className="bg-main-white-100 w-[90rem] shrink-0 flex flex-row items-center justify-start py-[5rem] px-[5.13rem] box-border">
      <div className="flex-1 h-[45rem] flex flex-row items-center justify-start">
