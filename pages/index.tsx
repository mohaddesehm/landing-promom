...
const Home: NextPage = () => {
  return (
    <div className="relative w-full h-[330.44rem] flex flex-col items-start justify-start">
      <section className="self-stretch bg-main-white-100 h-[50.5rem] overflow-hidden shrink-0 flex flex-col items-center justify-start pt-[0rem] px-[0rem] pb-[7.13rem] box-border gap-[7.13rem]">
